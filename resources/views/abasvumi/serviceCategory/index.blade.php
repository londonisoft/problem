            ...
            <div class="card">
                <div class="card-body">
                  <table class="table table-bordered table-striped table-sm text-center">
                    ...
                    <tbody id="allRole">
                      @foreach($service_categories as $serviceCat)
                        <tr class="role-{{ $serviceCat->id }}">
                            <td>{{ $serviceCat->name }}</td>
                            <td>{{ $serviceCat->name_bn }}</td>
                            <td style="vertical-align:middle;text-align:center;">{{ ($serviceCat->is_menu) ? "Menu" : ""}}</td>                                  
                            ...
                            <td style="vertical-align:middle;text-align:center;">
                                ...
                                <button class="btn btn-sm btn-warning" id="updateStatus" data-toggle="modal" data-target="#statusModal" data-id="{{ $serviceCat->id }}" data-is_menu="{{ $serviceCat->is_menu }}" data-status="{{ $serviceCat->status }}" title="Edit"><i class="fas fa-plus"></i></button>
...
@endsection
@section('scripts')
<script src="{{ asset('abasvumi/admin/js/serviceCategory.js') }}"></script>
...
<script>    
 ...
 $(document).on('click', '#updateStatus', function () {
    ...
    $("#destroyUser").click(function(){
        $.ajax({
            type: 'POST',
            url: '/admin/serviceCategory/status',
