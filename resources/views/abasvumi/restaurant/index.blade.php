  ...
  <div class="content-wrapper">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                  <h5 class="modal-title text-center w-100">Create New Restaurant</h5>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select id="type" class="form-control select2">
                              ...
                              <option value="1">3 start</option>
                              <option value="2">4 start</option>
                              <option value="3">5 start</option>
                          </select>
    ...
    <div class="modal fade" tabindex="-1" id="editEducationModal" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                  <h5 class="modal-title text-center w-100">Edit Restaurant</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
...
@endsection
@section('scripts')
<script src="{{ asset('abasvumi/admin/js/restaurant.js') }}"></script>
