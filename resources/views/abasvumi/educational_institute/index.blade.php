  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Educational Institute</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <table id="category" class="table table-bordered table-striped table-sm">
                      ...
                      <tfoot>
                        <tr>
                          ...
                          <th style="width:150px;text-align:center;">Thana</th>
                          <th style="width:150px;text-align:center;">Name</th>
                          <th style="width:350px;text-align:center;">Bangla Name</th>
                          <th style="width:150px;text-align:center;  text-align:center;">Action</th>
                        </tr>
                      </tfoot>
                    </table>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                  <h5 class="modal-title text-center w-100">Create New Education Institute</h5>
    ...
    <div class="modal fade" tabindex="-1" id="editEducationModal" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                  <h5 class="modal-title text-center w-100">Edit Educational Institute</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="edit_bn_description">Description (Bn)<span class="text-danger" title="Required">*</span></label>
                        <textarea id="edit_bn_description" class="form-control" placeholder="English description"></textarea>
                      <span class="text-danger errorBnDescription"></span>
                    </div>
                  </div>
...
@endsection
@section('scripts')
<script src="{{ asset('abasvumi/admin/js/education.js') }}"></script>
