  ...
  <div class="content-wrapper">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                  <h5 class="modal-title text-center w-100">Create New Hospital</h5>
                ...
                <form id="createEducationForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <textarea  id="bn_description" class="form-control"></textarea>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select id="type" class="form-control select2">
                              ...
                              <option value="2">Meternity clinic</option>
    ...
    <div class="modal fade" tabindex="-1" id="editEducationModal" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                  <h5 class="modal-title text-center w-100">Edit Hospital</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                ...
                <div class="modal-body">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea id="edit_bn_description" class="form-control"></textarea>
                      <span class="text-danger errorBnDescription"></span>
                    </div>
                  </div>
...
@endsection
@section('scripts')
<script src="{{ asset('abasvumi/admin/js/hospital.js') }}"></script>
