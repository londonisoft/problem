    ...
    */
    public function store(Request $request) {
        ...
        $this->validate($request,[
            ...
            'properties_thumbnail.required' => 'Property image is requried',
        ]);
        ...
        try{
            ...
            $service                         = new Service();
            $service->developer_id           = $request->developer_id;
            ...
            $service->developer_contact_no   = $request->developer_contact_no;
            ...
            if($service->save()){
                ...
                return response()->json([
                    'status'     => true,
                    'message'    => 'Service created wait for approvement.',
                ]);
            }
        }catch (Exception $error) {
            return response()->json([
