    ...
    $.ajax({
        ...
        success:function(response){
            if((response.errors)){
                ...
                $("#type").val('');
                $("#image").val('');
                toastr.success('Created religious.')
            }
        }
    });
});
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            if((response.errors)){
                ...
                $("#type").val('');
                $("#edit_image").val('');
                toastr.success('Update religious.')
            }
        }
    });
});
...
$("#destroyEducation").click(function(){
    $.ajax({
        ...
        success: function (data) {
            ...
            toastr.success('Religious Deleted')
        }
    });
});