...
$("#createEducation").click(function (e) {
    e.preventDefault();
    //console.log('description val ==='+ CKEDITOR.instances['description'].getData() );
    ...
    $.ajax({
        ...
        success:function(response){
            if((response.errors)){
                ...
                $("#type").val('');
                $("#image").val('');
                toastr.success('Created Education.')
            }
        }
    });
});
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            if((response.errors)){
                ...
                $("#type").val('');
                $("#edit_image").val('');
                toastr.success('Update Education.')
            }
        }
    });
});
