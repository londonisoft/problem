...
$("#createUser").click(function (e) {
    ...
    form_data.append('role_id', $("#role_id :selected").val());
        ...
        success:function(response){
            if((response.errors)){
                ...
                if (response.errors.role_id) {
                    $('.errorRole').text(response.errors.role_id);
                }                
                ...
                $("#allUser").append('' +
                    '<tr class="user-'+ response.data.id +'">\n' +
                        ...
                        '<button class="btn btn-warning btn-sm" data-toggle="modal" id="editUser" data-target="#editUserModal" data-id="'+ response.data.id +'" data-name="'+ response.data.name +'" data-email="'+ response.data.email +'" data-phone="'+ response.data.phone +'" data-role_id="'+ response.data.role_id +'" data-image="'+ response.data.image +'" title="Edit"><i class="fas fa-pencil-alt"></i></button>\n' +
...
$("#updateUser").click(function (e) {
    ...
    form_data.append('role_id', $("#edit_role_id :selected").val());
    $.ajax({
        type:'POST',
